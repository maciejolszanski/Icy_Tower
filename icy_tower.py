...
class IcyTower():
    ...
    def _create_initial_floors(self):
        ...
        # calculate availabe space and number of initial floors to be drawn
        available_space = (self.settings.screen_height -
                           self.settings.floor_height)
        num_of_floors = (available_space // self.settings.dist_between_floors
                         + 1)
        ...
        for num in range(num_of_floors):
            ...
            # rest of the floor is randomly sized and places
                ...
                x_pos = random.randint(self.settings.floor_margin,
